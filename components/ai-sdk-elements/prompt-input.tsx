...
import {
  ...
  CommandList,
  CommandSeparator,
} from "@/components/ai-sdk-elements/command";
import {
  HoverCard,
  HoverCardContent,
  HoverCardTrigger,
} from "@/components/ai-sdk-elements/hover-card";
import {
  InputGroup,
  InputGroupAddon,
  InputGroupButton,
  InputGroupTextarea,
} from "@/components/ai-sdk-elements/input-group";
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem,
...
const requestSubmitIfEnabled = (textarea: HTMLTextAreaElement) => {
  const { form } = textarea;
  ...
  const handleKeyDown: KeyboardEventHandler<HTMLTextAreaElement> = useCallback(
    (e) => {
      ...
      if (
        ...
        e.preventDefault();
        requestSubmitIfEnabled(e.currentTarget);
      }

      // Remove last attachment when Backspace is pressed and textarea is empty
      if (
        !isBackspaceOnEmptyValue({
          key: e.key,
