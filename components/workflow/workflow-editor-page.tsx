...
function WorkflowEditor({ params }: WorkflowPageProps) {
  ...
  return (
    <div className="pointer-events-none relative flex h-full w-full flex-col overflow-hidden">
...
export function WorkflowEditorPage({ params }: WorkflowPageProps) {
  return <WorkflowEditor params={params} />;
}
